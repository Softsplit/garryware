...
public static class WeaponConVars
{
	...
	/// </summary>
	[ConVar( "ware.weapon.unlimitedammo", ConVarFlags.Replicated, Help = "When enabled, weapons have unlimited ammo." )]
	...
	/// </summary>
	[ConVar( "ware.weapon.infinitereserves", ConVarFlags.Replicated, Help = "When enabled, reserve ammo is infinite — clip ammo is still consumed." )]
